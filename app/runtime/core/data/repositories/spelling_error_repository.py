...
from core.data.models.orm_models import SpellErrorORM
...
class SpellingErrorRepository:
    ...
    def create_error(self, error_word: str, version_id: int):
        ...
        new_error = SpellErrorORM(word=error_word, version_id=version_id)
    ...
    def get_errors_by_version(self, version_id: int):
        ...
        errors = self.session.query(SpellErrorORM).filter_by(version_id=version_id).all()
    ...
    def delete_errors_by_version(self, version_id: int):
        ...
        self.session.query(SpellErrorORM).filter_by(version_id=version_id).delete()
        self.session.commit()
